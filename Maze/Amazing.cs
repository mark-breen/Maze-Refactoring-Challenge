...
namespace Maze
{
    public class Amazing
    {
        ...
        public static ArrayPrinter VArrayPrinter;
        public static ArrayPrinter WArrayPrinter;
        ...
        public static void doit(int horizontal, int vertical) 
        {
            ...
            WArrayPrinter = new ArrayPrinter("wArray", wArray, vertical, horizontal);
            VArrayPrinter = new ArrayPrinter("vArray", vArray, vertical, horizontal);
    ...
    public class ArrayPrinter
    {
        ...
        public ArrayPrinter(string arrayName, int[,] array, int vertical, int horizontal)
        {
            _array = array;
            _vertical = vertical;
        ...
        public string ToString()
        {
            ...
            sb.AppendLine();
            sb.AppendLine(_arrayName);
            for (var j = 1; j <= _vertical; j++)
            {
                for(var y = 0; y < 2; y++)
                {
                    var rowLabel = y == 0
